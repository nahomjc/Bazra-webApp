...
export default function AgentTransfer() {const jwt =JSON.parse(localStorage.getItem('jwt'));
...
async function login(){
 ...
 const options={
  ...
  const url ="http://ec2-3-85-27-213.compute-1.amazonaws.com:8080/api/accounts/sendmoney"
  try{
